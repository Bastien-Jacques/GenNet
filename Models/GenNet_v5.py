...
# Ajout de deux couches hidden pour la tête de prédiction de Cd
# Ajout d'une fonction d'activation Tanh pour la tête de sortie SDF
# Ajout de weight normalisation pour chaque couche 
...
class SDFDecoder(nn.Module):
    ...
    def forward(self, x, z): #x = batch de points 3D, z: batch de vecteurs latents
        ...
        sdf = torch.tanh(sdf)                          # Ajout d'une 
