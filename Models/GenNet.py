...
class SDFDecoder(nn.Module):
    def __init__(self, latent_dim, hidden_dim, dropout):
        super().__init__()
        self.fc1 = nn.Linear(latent_dim + 3, hidden_dim) # fully connected latent_dim + 3 --> hidden_dim
        ...
        self.head_cd = nn.Linear(hidden_dim, 1) #Cd head: hidden_dim --> 1
    ...
    def forward(self, x, z): #x = batch de points 3D, z: batch de vecteurs latents
        ...
        B, N, _ = x.shape # B = batch_dim, N = amount of points to calculate SDF
